...
Status: phase1 recovery implemented locally; phase2 scan-evidence projection is in progress. Baseline `b585f47`; staging has99 canonical migrations and the local candidate has109. This plan addresses the orchestration/reconciliation requirement in [phase3](../20260913-ezyvet-clinical-import/phase-03-complete-migration.md). Individual import/review/release workflows are implemented; their success is not whole-migration acceptance.
