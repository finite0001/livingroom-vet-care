...
Status: implementation contract independently reviewed; implementation not started; no native prescribing implementation or clinical approval claimed.
...
| [3. Patient and refill workspace](implementation-contract.md#staff-workflows) | Planned | Reachable guarded editors, DVM signing, staff fulfillment, current history |
| [4. Labels and record release](implementation-contract.md#labels-and-record-release) | Planned | Frozen print artifacts and explicit selection in record packages |
