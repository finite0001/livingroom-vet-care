...
3. [Vaccinations, prescriptions, attachments and migration reconciliation](phase-03-complete-migration.md) — partially implemented; attachment metadata has merged verification and independent original capture has completed local integrated acceptance. Native chart/API-original provenance review, release integration, Consult/Contact attachment scope, whole-migration reconciliation and provider/clinical acceptance remain required. Do not omit these resources from completion because phase1/2 passes.
