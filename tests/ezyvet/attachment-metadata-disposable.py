...
try:
    ...
    assert len(versions) == 151 and {'20260924120000','20260924130000','20260926031324'} <= versions and not ({'20260913640000','20260913660000','20260913670000','20260913680000'} & versions), 'Refuse incompatible alternate attachment stack'
