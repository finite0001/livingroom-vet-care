...
try:
    ...
    # 136 since 20260921120000_a5_on_duty_guard.sql and
    # 20260921130000_a4_consent_submission_columns.sql. This count is a tripwire:
    # review it deliberately whenever the migration inventory changes.
    assert len(versions) == 136 and not ({'20260913640000','20260913660000','20260913670000','20260913680000'} & versions), 'Refuse incompatible alternate attachment stack'
