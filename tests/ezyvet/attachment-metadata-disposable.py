...
def command(argv, **kwargs):
    ...
    if result.returncode:
        print(f'Disposable command exited with status {result.returncode}; inspect protected log.', flush=True)
...
try:
    ...
    # 152 through 20260926090000_cloudtalk_activity.sql. This count is a tripwire:
    # review it deliberately whenever the migration inventory changes.
    assert len(versions) == 152 and {'20260924120000','20260924130000','20260926031324','20260926090000'} <= versions and not ({'20260913640000','20260913660000','20260913670000','20260913680000'} & versions), 'Refuse incompatible alternate attachment stack'
