...
harnesses = [root / 'tests/prescriptions' / name for name in ['local-lifecycle.ts', 'local-fulfillment.ts', 'local-workspace.ts']]
harness_hashes = {}
results = []
...
try:
    ...
    assert len(versions) == 119 and {'20260916055043','20260916062136','20260916063857','20260916070108','20260916072509'} <= versions, 'Canonical native prescription migration inventory required'
