...
export function validateReleaseApiAttachments(s: ReleaseSnapshot): void {
  if (s.schema_version !== 9 && s.schema_version !== 10 && s.schema_version !== 11 && s.schema_version !== 12 && s.schema_version !== 13) {
    if (
...
export function renderReleaseApiAttachments(s: ReleaseSnapshot): string {
  ...
  if ((s.schema_version !== 9 && s.schema_version !== 10 && s.schema_version !== 11 && s.schema_version !== 12 && s.schema_version !== 13) || !s.api_attachments!.length) return "";
