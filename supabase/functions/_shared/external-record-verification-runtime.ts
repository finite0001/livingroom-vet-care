...
import {createExternalRecordVerificationHandler} from "./external-record-verification.ts";
export function externalRecordVerificationRuntime(){
 ...
 return createExternalRecordVerificationHandler({enabled:Deno.env.get("EXTERNAL_RECORD_VERIFICATION_ENABLED")==="true",origin,
