...
insert into public.user_roles (user_id, role) values ('ae000000-0000-4000-8000-000000000001','STAFF'),('ae000000-0000-4000-8000-000000000002','STAFF') on conflict do nothing;
