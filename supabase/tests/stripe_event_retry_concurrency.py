...
try:
    ...
    sql(f"insert into auth.users(id,email,raw_user_meta_data) values('{actor}','retry-{actor}@example.test','{{}}');insert into public.user_roles(user_id,role) values('{actor}','ADMIN');")
