...
Both custom domains are now verified and Live in Lovable. GoDaddy saved TXT `_lovable.www` = `lovable_verify=7fab9dafe2dd2164e22c087b7604b92c8d208de2430fd1101924edcb2a4fd06b` after owner-supplied SMS verification. Authoritative DNS confirms the TXT. Existing www CNAME resolves through the root to the required hosting IP and was retained. Lovable confirmed DNS verification and provisioned the certificate. HTTPS request to `https://www.thelivingroom.vet/` successfully redirects to `https://thelivingroom.vet/` and returns 200 with normal certificate validation. Browser navigation through www also reaches the rendered root homepage. No further registrar verification remains for this rollout.
