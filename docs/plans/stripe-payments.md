...
- Amounts use integer cents. Invoice obligation is issued total minus accounting credits; net cash is successful collections minus successful refunds. Outstanding is the positive difference between obligation and net cash. Refunds return money; credits reduce what is owed. Refund preparation is limited to net cash above the current obligation (less pending refunds): staff first record an accounting credit for a service adjustment, then review the money to return. Duplicate collections are also refundable excess. This prevents a refund from silently reopening a settled invoice for recollection. Failed/pending refunds do not reduce settled net cash; pending refunds reserve refundable capacity. Disputes and unrecognized external adjustments enter reconciliation rather than silently changing invoice balances.
