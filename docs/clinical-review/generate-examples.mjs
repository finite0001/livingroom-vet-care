...
import { historyArtifact } from "../../tests/record-releases/history-fixture.ts";
...
const examples = [
  [
    ...
    "tests/record-releases/history-fixture.ts + charts-fixture.ts + fixture.ts",
    renderRecordRelease(structuredClone(historyArtifact)),
  ],
  [
