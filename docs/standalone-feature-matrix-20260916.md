...
| Conversation attachments | **Implemented candidate, not deployed:** PR156 and combined PR157 include private uploads, reviewed immutable outbound payloads, message history, inbound original capture/private reads, timeline controls and abandoned-upload cleanup. Combined CI run35109775246 passed. Separate [PR160](https://github.com/finite0001/livingroom-vet-care/pull/160) passed full populated communications database/Storage restore, including original MIME metadata and exact security; its CI/integration remain pending. Hosted staff acceptance and controlled provider delivery remain open. |
