...
| Conversation attachments | **Candidate, not deployed:** PRs150/152/153/156 add private staff uploads, reviewed immutable outbound payloads, shared message history, provider-bound incoming capture, authorized private reads and incoming timeline controls. Outbound CI passed atc04f45a; original incoming capture CI passed at9856659. Expanded incoming backend run35094146408 is still active; local timeline desktop/mobile PNG byte-download tests passed. Incoming concurrency, retention, deployed Edge/provider and hosted staff acceptance remain open. |
