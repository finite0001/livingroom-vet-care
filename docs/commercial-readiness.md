...
| Invoices and payment by text/email | Invoice/item/credit ledgers, PR23 print/download documents and PR42 frozen reviewed invoice email backend implemented; PR43 adds the staff review/recovery composer | Hosted invoice email acceptance, secure invoice delivery by text and payment ledger/Stripe sandbox reconciliation; Stripe connector needs reauthentication |
...
| PR43 | Staff exact-attachment preview and attestation, preserved drafts and receipts across failed refresh/void/retry, and sign-out cleanup; 163 combined units and 14 focused browser cases passed | Integrated CI and hosted staff/provider acceptance |
