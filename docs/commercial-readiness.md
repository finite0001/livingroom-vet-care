...
| Invoices and payment by text/email | Invoice/item/credit ledgers and reviewed invoice email; PR52/54/57 add payment/refund ledger, verified event inbox and provider handlers; PR59 adds staff controls; PR60/61 add reviewed collection grants and isolated client pages | Public capability endpoints, reviewed payment-link delivery, audited reconciliation resolution, hosted acceptance and real Stripe payment/refund/webhook tests; Stripe connector needs reauthentication |
