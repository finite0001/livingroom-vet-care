...
Local migration workspace checkpoint (2026-09-14): the 107-migration candidate now shows owned attachment capture and approval receipts alongside source-item evidence in the existing operator workspace. [Local validation and populated restore evidence](evidence/canonical-migration-capture-evidence-20260914.json) preserve duplicate-occurrence relationships, separate canceled decisions from approvals and verify owner boundaries. This candidate is not deployed. Other clinical outcome adapters, global reconciliation, operational resolutions, frozen reports, creation/binding/resume UI, supervised staff acceptance and external commissioning remain unfinished. The latest hosted backend remains the 99-migration checkpoint below.
