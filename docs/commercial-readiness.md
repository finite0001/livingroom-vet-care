...
| Unified inbox without Gmail dependence | PR16–18 signed Resend/Twilio ingestion, backend sender-assignment RPC, durable outbox, consent UI, personal read state and paginated inbox implemented | Unknown-sender browser review and provider-processing queue recovery are being implemented; controlled inbound/provider callbacks and hosted acceptance remain |
