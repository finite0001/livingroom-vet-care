...
- PR106 (`e80cf62`) has all three GitHub CI jobs green (run34746522048), including the complete browser suite. Patient-scoped consult/history ingestion remains staging for explicit review; real ezyVet account access and source validation remain pending.
