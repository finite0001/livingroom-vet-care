    ...
    <section className="py-24 lg:py-32 bg-background">
      <div className="container">
        ...
        <ScrollReveal className="text-center max-w-2xl mx-auto mb-16">
          <p className="text-primary font-heading text-sm font-semibold tracking-wide uppercase mb-3">Why We're Different</p>
            ...
            <StaggerItem key={feature.title}>
              <Card variant="feature" className="group h-full">
                <CardContent className="p-8">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-warm flex items-center justify-center mb-6 group-hover:scale-110 group-hover:shadow-warm transition-all duration-300">
                  ...
                  <span className="inline-flex items-center px-3 py-1.5 rounded-full bg-sage/15 text-sage-dark text-xs font-semibold tracking-wide">
                    {feature.highlight}
                  </span>
                </CardContent>
              </Card>
