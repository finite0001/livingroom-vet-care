...
new_versions = [f'20260914{v:02d}0000' for v in range(1,24)] + ['20260916000000']
if args.rehearse_staging_baseline:
    assert len(migration_files) == 111
...
if args.rehearse_observed_hosted_gaps:
    ...
    assert len(migration_files)==111 and len(initial_files)==51
